...
def cluster_images(embedding, pca_num_components: int, tsne_num_components: int):
    ...
    """
    pca_file_name = f"../models/pca_{pca_num_components}.pkl"
    tsne_file_name = f"../models/tsne_{tsne_num_components}.pkl"
    tsne_embeddings_file_name = (
        f"../models/tsne_embeddings_{tsne_num_components}.pkl"
    )
...
if __name__ == "__main__":
    # Loads the embedding
    embedding = np.load('../models/data_embedding_f.npy')
